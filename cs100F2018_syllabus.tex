...
language. That is, students should be comfortable with the use of Vim (and other
text editors such as Atom) and understand how to use software tools such a
...
Ninth Edition, ISBN:\ 0134462025, ISBN--13:\ 978-0134462028, 800 pages, 2017. \\
(References to the textbook are abbreviated as ``JSS'' on the course web site and the syllabus).

\vspace*{.1in}

\noindent Students who want to more information about Java or project ideas can
